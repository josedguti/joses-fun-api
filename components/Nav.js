              ...
              <div className="flex">
                ...
                <div className="flex-shrink-0 flex items-center">
                  <img
                    ...
                    src="https://i.imgur.com/Bo6UXqq.png"
                    alt="Workflow"
                  />
                  <img
                ...
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  ...
                  <Link href="/">
                    <div className="border-transparent text-white hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium cursor-pointer">
                      Home
                    </div>
                  </Link>
